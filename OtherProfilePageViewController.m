...
- (void)viewDidLoad {
    ...
    NSString *realName = [self.userToQuery objectForKey:@"realname"];
    if (realName) {
        self.realnameLabel.text = [self.userToQuery objectForKey:@"realname"];
    } else {
        self.realnameLabel.hidden = YES;
    }
    NSString *bio = [self.userToQuery objectForKey:@"bio"];
    if (bio) {
        self.bioTextView.text = [self.userToQuery objectForKey:@"bio"];
    } else {
