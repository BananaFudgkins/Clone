...
- (IBAction)resetPressed:(UIButton *)sender {
    ...
    UIAlertAction *done = [UIAlertAction actionWithTitle:NSLocalizedString(@"OK", @"OK") style:UIAlertActionStyleDefault handler:^(UIAlertAction *action) {
        ...
        if ([alertTextField hasText] && [self validateEmail:alertTextField.text]) {
            ...
            UIAlertController *validEmailBitch = [UIAlertController alertControllerWithTitle:NSLocalizedString(@"Please enter a valid email address", @"emailplease") message:NSLocalizedString(@"Please enter a valid email address before proceeding.", @"message") preferredStyle:UIAlertControllerStyleAlert];
